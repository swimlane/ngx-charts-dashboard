...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__chartTypes__ = __webpack_require__("./src/app/chart-builder/chartTypes.ts");
...
var ChartBuilderComponent = /** @class */ (function () {
    ...
    ChartBuilderComponent.prototype.setChartLabels = function () {
        ...
        var labels = this.chartType.chartLabels(this.dataDims.map(__WEBPACK_IMPORTED_MODULE_6__utils__["a" /* toCapitalizedWords */]));
    ...
    ChartBuilderComponent.prototype.updateColorScheme = function () {
        ...
        return this.chartOptions.colorScheme = __assign({}, this.chartOptions.colorScheme, { domain: domain });
    };
    ...
    ChartBuilderComponent.prototype.updateColorSchemeDiv = function () {
        ...
        return __WEBPACK_IMPORTED_MODULE_3_chroma_js__["scale"](domainL.concat(domainR)).colors(this.steps);
    };
    ChartBuilderComponent.prototype.getColorScale = function (colors, bezier, lightness) {
        var cleanColors = clean(colors);
        var scale = bezier ? __WEBPACK_IMPORTED_MODULE_3_chroma_js__["bezier"](cleanColors.slice(0, 5)).scale() : __WEBPACK_IMPORTED_MODULE_3_chroma_js__["scale"](cleanColors);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_svgsaver__ = __webpack_require__("./node_modules/svgsaver/lib/svgsaver.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_svgsaver___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_svgsaver__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChartComponent = /** @class */ (function () {
    function ChartComponent() {
        ...
        this.svgSaver = new __WEBPACK_IMPORTED_MODULE_1_svgsaver__();
    }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('class.has-active-entries'),
        __metadata("design:type", Object),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_papaparse__ = __webpack_require__("./node_modules/papaparse/papaparse.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_collection__ = __webpack_require__("./node_modules/d3-collection/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.updateData = function (dataText) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this._parsed = __WEBPACK_IMPORTED_MODULE_2_papaparse__["parse"](dataText, {
                            header: true,
                            dynamicTyping: true,
                            skipEmptyLines: true
                        });
    ...
    DataService.prototype.getChartSeriesFromQuery = function (query, yKey, aggragate) {
        ...
        if (data.length > 0 && Array.isArray(data[0].name)) {
            data = Object(__WEBPACK_IMPORTED_MODULE_3_d3_collection__["b" /* nest */])()
